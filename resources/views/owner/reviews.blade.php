...
@section('title', 'My Activity Reviews - PRISM FLUX')
@section('styles')
...
@section('header')
    <header class="admin-header">
        <div class="header-title">
            <h1>My Activity Reviews</h1>
            <p>View and manage reviews for your activities</p>
        </div>
...
@section('sidebar')
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('owner.reviews') }}" class="{{ request()->routeIs('owner.reviews') ? 'active' : '' }}">Reviews & Ratings</a>
    </nav>
@endsection
